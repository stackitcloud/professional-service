...
output "ske_node_network_id" {
  description = "The node network ID used by the SKE cluster"
...
output "alb_public_ip" {
  description = "The public IP of the ALB provisioned by the managed controller for the demo Ingress"
